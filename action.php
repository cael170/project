...
if (isset($_POST["Common"])) {
	...
	if (isset($_POST["getCartItem"])) {
		if (mysqli_num_rows($query) > 0) {
			...
			?>
				<a style="float:right;" href="cart.php" class="btn btn-warning">Order&nbsp;&nbsp;<span class="glyphicon glyphicon-edit"></span></a>
			<?php
			exit();
		}
	}
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@projectstore.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/ProjectStore/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/ProjectStore/cancel.php"/>
